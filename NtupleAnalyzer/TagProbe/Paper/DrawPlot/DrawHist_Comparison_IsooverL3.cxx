...
void DrawHistForEachVariable(TString var, Bool_t setZoomIn = kFALSE)
{
  TString fileName1 = "Run2018__2019_03_21_054604__IsooverL3.root";
  TString fileName2 = "Run2018__2019_03_21_054604__IsooverL3.root"; // -- can be replaced by the other root file
  ...
  canvasRatio->RegisterLatex( 0.16, 0.91, "#font[42]{#scale[0.6]{IsoFilter/L3}}");
  if( var != "Pt" )
