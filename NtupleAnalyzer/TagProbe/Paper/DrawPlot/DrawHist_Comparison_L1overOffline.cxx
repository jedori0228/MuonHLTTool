...
TString fileName1 = "L1overOffline__Run2016.root";
TString fileName2 = "L1overOffline__Run2017.root";
TString fileName3 = "L1overOffline__Run2018.root";
...
void DrawHist_Comparison_L1overOffline() {
  ...
  c_2D_1->SaveAs("outputs/L1overOffline/c_vsEta_vs_Phi_2016.pdf");
  c_2D_1->Close();
  ...
  c_2D_2->SaveAs("outputs/L1overOffline/c_vsEta_vs_Phi_2017.pdf");
  c_2D_2->Close();
  ...
  c_2D_3->SaveAs("outputs/L1overOffline/c_vsEta_vs_Phi_2018.pdf");
  c_2D_3->Close();
  ...
  c_2D_2over1->SaveAs("outputs/L1overOffline/c_vsEta_vs_Phi_2017over2016.pdf");
  c_2D_2over1->Close();
  ...
  c_2D_3over1->SaveAs("outputs/L1overOffline/c_vsEta_vs_Phi_2018over2016.pdf");
  c_2D_3over1->Close();
  ...
  c_2D_3over2->SaveAs("outputs/L1overOffline/c_vsEta_vs_Phi_2018over2017.pdf");
  c_2D_3over2->Close();
...
void DrawHistForEachVariable(TString var, Bool_t setZoomIn = kFALSE, int FirstBinIndexFor2D=-1, int FirstBinXIndexFor2D=-1)
{
  ...
  //TString fileName1 = "L1overOffline_NoL1PtCut__Run2016.root";
  //TString fileName2 = "L1overOffline_NoL1PtCut__Run2018.root";
  ...
  //==== output info
  TString outdir = "outputs/L1overOffline";
  ...
  canvasRatio->SetTitle( titleX, "L1 / Offline efficiency", "2018/2016");
  ...
  canvasRatio->SetRangeY( 0.60  , 1.10 );
  if( var == "Pt" && !setZoomIn) canvasRatio->SetRangeY( 0.60, 1.10 );
  ...
  // canvasRatio->RegisterLatex( 0.16, 0.91, "#font[42]{#scale[0.6]{L1/L1}}");
  if( var != "Pt" )
