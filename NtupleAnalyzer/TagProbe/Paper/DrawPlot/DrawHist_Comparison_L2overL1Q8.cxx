...
TString fileName1 = "L2overL1Q8__Run2016.root";
TString fileName2 = "L2overL1Q8__Run2017.root";
TString fileName3 = "L2overL1Q8__Run2018.root";
...
void DrawHist_Comparison_L2overL1Q8() {
  ...
  c_2D_1->SaveAs("outputs/L2overL1Q8/c_vsEta_vs_Phi_2016.pdf");
  c_2D_1->Close();
  ...
  c_2D_2->SaveAs("outputs/L2overL1Q8/c_vsEta_vs_Phi_2017.pdf");
  c_2D_2->Close();
  ...
  c_2D_3->SaveAs("outputs/L2overL1Q8/c_vsEta_vs_Phi_2018.pdf");
  c_2D_3->Close();
  ...
  c_2D_2over1->SaveAs("outputs/L2overL1Q8/c_vsEta_vs_Phi_2017over2016.pdf");
  c_2D_2over1->Close();
  ...
  c_2D_3over1->SaveAs("outputs/L2overL1Q8/c_vsEta_vs_Phi_2018over2016.pdf");
  c_2D_3over1->Close();
  ...
  c_2D_3over2->SaveAs("outputs/L2overL1Q8/c_vsEta_vs_Phi_2018over2017.pdf");
  c_2D_3over2->Close();
...
void DrawHistForEachVariable(TString var, Bool_t setZoomIn = kFALSE, int FirstBinIndexFor2D=-1, int FirstBinXIndexFor2D=-1)
{
  ...
  //TString fileName1 = "L2overL1Q8_NoL2PtCut__Run2016.root";
  //TString fileName2 = "L2overL1Q8_NoL2PtCut__Run2018.root";
  ...
  //==== output info
  TString outdir = "outputs/L2overL1Q8";
  ...
  canvasRatio->SetTitle( titleX, "L2 / L1(p_{T}>15 GeV, Quality#ge8) efficiency", "2018/2016");
