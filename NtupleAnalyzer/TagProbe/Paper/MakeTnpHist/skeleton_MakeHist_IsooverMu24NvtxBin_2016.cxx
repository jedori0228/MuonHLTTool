...
public:
  ...
  Bool_t IsProbe()
  {
    ...
    if( probe_.isTight && 
        ...
        MuonHLT::dRMatching_HLTObj(probe_.vecP, ntuple_, "hltL3fL1sMu22L1f0L2f10QL3Filtered24Q::HLT", 0.1) )
      flag = kTRUE;
  ...
  Bool_t IsPassingProbe()
  {
    ...
    if( MuonHLT::dRMatching_HLTObj(probe_.vecP, ntuple_, "hltL3crIsoL1sMu22L1f0L2f10QL3f24QL3trkIsoFiltered0p09::HLT", 0.1) )
      flag = kTRUE;
