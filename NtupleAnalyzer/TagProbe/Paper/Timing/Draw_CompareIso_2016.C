...
void Draw_CompareIso_2016(){
  ...
  "Run283407 (2016)",  //"PU48-49 Menu-HLTv3.5V10Run319941",
  ...
  for(unsigned int i=0; i<Runs.size(); i++){
    ...
    TLegend *lg2 = new TLegend(0.34, 0.80, 0.99, 0.90);
    lg2->SetBorderSize(0);
    lg2->SetFillStyle(0);
    ...
    for(unsigned int it_Path=0; it_Path<Paths.size(); it_Path++){
      ...
      cout << "DQMData/Run "+Run+"/HLT/Run summary/TimerService/Running 1 processes/process TIMING/Paths/"+Path+"_total" << endl;
      ...
      hist->SetLineStyle(styles.at(it_Path));
      hist->SetLineWidth(2);
    ...
    lg2->Draw();
    c_Path->SaveAs(OutDir+"/Run_"+Run+"_2016_Iso.pdf");
    c_Path->SaveAs(OutDir+"/Run_"+Run+"_2016_Iso.png");
    c_Path->Close();
